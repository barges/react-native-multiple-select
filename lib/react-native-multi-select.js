...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    tagBorderRadius: PropTypes.number,
    ...
    displayRowSeparator: PropTypes.bool,
    placeholderFunc: PropTypes.func
  };
  ...
  static defaultProps = {
    ...
    placeholderFunc: null,
    tagBackgroundColor: '#FFFFFF00',
    tagBorderRadius: 20
  };
      ...
      return (
        <View
          style={[
            styles.selectedItem,
            {
              width: item[displayKey].length * 8 + 67,
  ...
  _getRow = item => {
    ...
    const separator = displayRowSeparator ? (
      <View style={ { height: 0.5, backgroundColor: '#D8D8D8', width: '100%', marginLeft: 20 } } />
    ) : null;
    return (
      <TouchableOpacity
      ...
      >
        {selector ? (
          ...
          >
            ...
            <View style={ { height: 0.5, width: '100%', backgroundColor: '#C0C0C0' } } />
            <View
              style={{
                flexDirection: 'column',
          ...
          <View>
            ...
            >
              ...
              >
                <TouchableWithoutFeedback onPress={ placeholderFunc || this._toggleSelector}>
